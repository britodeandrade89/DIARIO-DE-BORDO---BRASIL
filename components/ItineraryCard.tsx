...
const ItineraryCard: React.FC<{ itinerary: Itinerary; onSelect: (itinerary: Itinerary) => void; }> = ({ itinerary, onSelect }) => {
    ...
    if (companyName.includes('latam')) themeColor = '#0033A0';
    else if (companyName.includes('flybondi')) themeColor = '#FFD700';
    else if (companyName.includes('jetsmart')) themeColor = '#0033A0';
    else if (companyName.includes('sul') || companyName.includes('branca')) themeColor = '#0033A0';
    ...
    return (
        <div 
            ...
            className="bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden transform transition-all duration-200 hover:shadow-lg hover:scale-[1.02] flex flex-col cursor-pointer"
            ...
            <div className="p-5 flex-grow flex flex-col">
                ...
                <div className="mt-auto pt-4 border-t border-slate-100">
                     <div className="flex items-center text-sm text-slate-600">
                        <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-slate-100 mr-3">
